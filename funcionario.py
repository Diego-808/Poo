...
class Gerente(Funcionario):
    ...
    def exibir_dados(self):
        ...
        print(f"Salario após Bonus: {self.get_salario() + self.__bonus}")
...
funcionario1 = Gerente("Diego From the Block", 12333244465, 8500, 500)
funcionario1.exibir_dados()

funcionario2 = Operacional("Ken Carson", 12345678901, 8700, "noite")
